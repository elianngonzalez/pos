          ...
          <div class="page-header">
            <h3 class="page-title">
             ...
             <nav aria-label="breadcrumb">
              <ol class="breadcrumb"> 
                <li class="breadcrumb-item"><a href="{{ route('purchases.index') }}">
                  Inicio
                </a></li>
